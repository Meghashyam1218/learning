<script lang="ts">
    ...
    // Onboarding data
    let items = [
        'Introduction to Programming (Python)', 'Data Structures & Algorithms', 'SQL and NoSQL Databases', 
        'System Design', 'Object-Oriented Design (OOP)', 'Operating Systems Concepts', 'DBMS', 
        'Version Control with Git', 'HTML, CSS, & Web Development Basics', 'RESTful APIs & Web Services', 
        'Cloud Fundamentals', 'Machine Learning & AI', 'Microservices Architecture', 'DevOps & CI/CD Pipelines', 
        'Data Science & Analytics', 'Artificial Intelligence Ethics & Applications', 'Blockchain Basics', 
